...
export default function SportsBanner() {
  return (
    <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
      {/* Background image */}
      <img
        src="https://i.ibb.co/fzqHnQK8/peakpx.jpg"
      ...
      <div className="relative z-10 text-center p-6 max-w-3xl">
        ...
        <p className="mt-6 text-lg leading-relaxed text-white">
          At our club, we believe in nurturing talent and building a strong
          sports community. From world-class coaching to state-of-the-art
          facilities, we provide everything you need to push your limits and
          achieve your goals. Be it football, basketball, athletics, or
          swimming—there's a place for everyone here.
        </p>
